...
<article>
	...
	<?php if( get_theme_mod( 'multipurpose_magazine_metafields_date',true) != '' || get_theme_mod( 'multipurpose_magazine_metafields_author',true) != '' || get_theme_mod( 'multipurpose_magazine_metafields_comment',true) != '') { ?>
    	<div class="post-info">
			...
			<?php }?>
			<?php if( get_theme_mod( 'multipurpose_magazine_metafields_author',true) != '') { ?>
			...
			<?php }?>
			<?php if( get_theme_mod( 'multipurpose_magazine_metafields_comment',true) != '') { ?>
	...
	if ( is_singular( 'attachment' ) ) {
		...
		the_post_navigation( array(
			'next_text' => '<span class="meta-nav" aria-hidden="true">' . __( 'Next<i class="fas fa-angle-double-right"></i>', 'multipurpose-magazine' ) . '</span> ' .
				'<span class="screen-reader-text">' . __( 'Next post:', 'multipurpose-magazine' ) . '</span> ' .
				'',
			'prev_text' => '<span class="meta-nav" aria-hidden="true">' . __( '<i class="fas fa-angle-double-left"></i>Previous', 'multipurpose-magazine' ) . '</span> ' .
