  ...
  <header role="banner">
    <div id="header">
                            ...
                            <div class="row m-0">
                              <div class="col-lg-9 col-md-9 col-8">
                                ...
                                <div class="col-lg-3 col-md-3 col-4">
                                  <div class="know-btn">
                                    <a href="<?php esc_url(the_permalink()); ?>" class="blogbutton-small"><?php esc_html_e('BUY NOW','multipurpose-magazine'); ?><span class="screen-reader-text"><?php esc_html_e( 'BUY NOW', 'multipurpose-magazine' ); ?></span></a>
                                  </div>
                                </div>
                            </div>
                          </div>
      ...
      <div class="toggle-menu responsive-menu">
        <button role="tab" onclick="multipurpose_magazine_resMenu_open()"><i class="fas fa-bars"></i><?php esc_html_e('Menu','multipurpose-magazine'); ?><span class="screen-reader-text"><?php esc_html_e('Menu','multipurpose-magazine'); ?></span></button>
      </div>
        ...
        <div class="container"> 
          <div id="sidelong-menu" class="nav side-nav">
            <nav id="primary-site-navigation" class="nav-menu" role="navigation" aria-label="<?php esc_attr_e( 'Top Menu', 'multipurpose-magazine' ); ?>">
              ...
              ?>
              <a href="javascript:void(0)" class="closebtn responsive-menu" onclick="multipurpose_magazine_resMenu_close()"><?php esc_html_e('Close Menu','multipurpose-magazine'); ?><i class="fas fa-times-circle"></i><span class="screen-reader-text"><?php esc_html_e('Close Menu','multipurpose-magazine'); ?></span></a>
            </nav>
          </div>
        </div>
      </div>
